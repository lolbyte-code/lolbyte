...
function updateMatchDetailSelectionElement(gameId) {
    ...
    $('#matchDetailSelection #stats #kdaLong').html(selectedSummoner.kdaLong)
    $('#matchDetailSelection #stats #kdaShort').html(selectedSummoner.kdaShort)
    $('#matchDetailSelection #stats #level').html(selectedSummoner.level)
    $('#matchDetailSelection #stats #cs').html(selectedSummoner.cs)
    $('#matchDetailSelection #stats #gold').html(selectedSummoner.gold)
